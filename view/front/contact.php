<div id="main">
    ...
    <div class="row">
            ...
            <div class="well well-sm">
                <form class="form-horizontal" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-md-10 col-md-offset-1">
                                <textarea class="form-control" id="message" name="message" placeholder="Entrer votre message" rows="7"></textarea>
                            </div>
                        </div>
        ...
        <div class="col-md-6">
            <div>
                <div class="well well-sm">
                        <legend class="text-center header">Siège social</legend>
                    <div class="panel-body text-center">
                        ...
                        <hr />
                        <div id="map1" class="map" style="height: 233px;">
                        </div>
                    </div>
                </div>
            </div>
